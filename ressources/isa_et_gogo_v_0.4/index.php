...
<body onload="message()"> 
	...
	<div class="navigation">
		<a href="#slide1" data-slide="1" class="tooltip li_1" data-tooltip="Wedding"> <img class="nav_img" src="images/menu/li_1.png" alt="wedding_picto_1" /> </a>	
		<a href="#slide2" data-slide="2" class="tooltip li_2" data-tooltip="Vols"> <img class="nav_img" src="images/menu/li_2.png" alt="wedding_picto_2" /> </a>	
		<a href="#slide3" data-slide="3" class="tooltip li_3" data-tooltip="Hebergements"> <img class="nav_img" src="images/menu/li_3.png" alt="wedding_picto_1" /> </a>	
		<a href="#slide4" data-slide="4" class="tooltip li_4" data-tooltip="Faq"> <img class="nav_img" src="images/menu/li_4.png" alt="wedding_picto_1" /> </a>	
		<a href="#slide5" data-slide="5" class="tooltip li_5" data-tooltip="Checklist"> <img class="nav_img" src="images/menu/li_5.png" alt="wedding_picto_1" /> </a>	
		<a href="#slide6" data-slide="6" class="tooltip li_6" data-tooltip="Que faire ?"> <img class="nav_img" src="images/menu/li_6.png" alt="wedding_picto_1" /> </a>	
		<a href="#slide7" data-slide="7" class="tooltip li_7" data-tooltip="Contact"> <img class="nav_img" src="images/menu/li_7.png" alt="wedding_picto_1" /> </a>
		<a href="#slide8" data-slide="8" class="tooltip li_8" data-tooltip="Wedding Gift"> <img class="nav_img" src="images/menu/li_8.png" alt="wedding_picto_1" /> </a>	
	</div>
	...
	<div class="slide" id="slide1" data-slide="1" data-stellar-background-ratio="0.5">
		<div class="content">
			...
			<h2>Mombassa<img class="img_h" src="images/drapeau_kenya.gif" alt="Drapeau Kenyan">Kenya</h2>
			<h3>North Coast</h3>
		</div>
	...
	<div class="slide" id="slide2" data-slide="2" data-stellar-background-ratio="0.5">
		<div class="content">
			<p>Il existe plusieurs moyens pour se rendre à Mombasa, via vols directs ou indirects. Ci-dessous vous trouverez les différentes options possibles.</p>
			<div class="col4">
				<h2><a class="titre2" href="http://www.brusselsairlines.com/fr_be/" target="_blank">Brussels Airlines</a></h2>
				<div class="inside">
					<h3>Routing :</h3>
					<p>Aller : BXL - MBA</p>
	...
	<div class="slide" id="slide3" data-slide="3" data-stellar-background-ratio="0.5">
		<div class="content">
			<p>Le mariage se déroulera sur la côte Nord de Mombasa. Bien qu’il y ait beaucoup d’hôtels, nous vous déconseillons de choisir un logement sur la côte sud de Mombasa. En effet, seul un bateau permet de faire la traversée entre la côte Nord & Sud. Cette traversée peut prendre quelques minutes comme quelques heures malgré la courte distance.</p>
			<p>Les quartiers les plus proches sont Nyali, Bamburi ou Shanzu (communes du nord de la ville de Mombasa). Mtwapa et Vipingo se trouvent un peu plus au Nord mais toujours à une distance raisonnable (+-15 min pour Mtwapa et +-25min pour Vipingo). Nous vous déconseillions d'aller plus loin que Vipingo - Kikambala.</p>
			...
			<div id="accordeon" class="Accordion" tabindex="0">
				<div class="AccordionPanel">
				  ...
				  <div class="AccordionPanel">
				    ...
				    <div class="AccordionPanelContent">
				    	<p>Si vous venez d'Europe, aucun vaccin n'est obligatoire, mais la vaccination contre les maladies suivantes est recommandée :</p>
				        <ul>
				        ...
				        <p>A Bruxelles, seul le « CHU St. Pierre, site César De Paepe » permet une visite sans rendez-vous. De plus un traitement antipaludéen est vivement conseillé (Demandé conseil à votre médecin).</p>
				  </div>
				  </div>
				  <div class="AccordionPanel">
	...
	<div class="slide" id="slide7" data-slide="7" data-stellar-background-ratio="0">
		<div class="content">
			<div class="wrap">
				<div class="contact">
					<img class="photo" src="images/photo.png" alt="Isabelle Contact Photo">
					<h2>Isabelle</h2>
					<p>+32 474 22 02 32</p>
				</div>
				<div class="contact">
					<img class="photo" src="images/photo.png" alt="Gautier Contact Photo">
					<h2>Gautier</h2>
					<p>+32 474 62 56 54</p>
				</div>
